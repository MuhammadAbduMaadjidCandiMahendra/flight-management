...
public class RunFlightScreen extends Screen {
    private final RouteService routeService;
    private final SystemOperationalService systemOperationalService;

    public RunFlightScreen(ScreenFactory screenFactory, Scanner scanner, RouteService routeService, SystemOperationalService systemOperationalService) {
    ...
    protected void renderScreen() {
        ...
        if (routes.isEmpty()) {
            throw new IllegalStateException("No flight scheduled today");
        }
