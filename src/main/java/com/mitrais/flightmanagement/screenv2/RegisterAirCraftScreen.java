...
public class RegisterAirCraftScreen extends Screen {

    private final AircraftService aircraftService;

    public RegisterAirCraftScreen(ScreenFactory screenFactory, Scanner scanner, AircraftService aircraftService) {
